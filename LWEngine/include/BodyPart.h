...
enum LimbType{HEAD, UPPER_TORSO, LOWER_TORSO, ARM, LEG, HAND, FOOT, TAIL, BREAST, DICK, TESTICLE, CUNT, ANUS, FACE, EYE, NOSE, EAR, MOUTH, BRAIN, HAIR, WING, HORN, ARM_WING};
